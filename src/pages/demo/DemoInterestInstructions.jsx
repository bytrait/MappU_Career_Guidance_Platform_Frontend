...
export default function DemoInterestInstructions({ onStart }) {
  return (
    <div className="fixed inset-0 flex justify-center items-center">
      <div className="w-full max-w-6xl p-6 rounded-sm flex flex-col justify-center bg-white shadow z-50">
        ...
        <p className="text-sm text-gray-500 italic mb-6">
          Note: This demo test contains only <strong>6 questions</strong>, while the actual main test contains <strong>30 questions</strong> for a more detailed analysis.
        </p>
